export const PAY_LEVELS = [
  ...
  'AL-10', 'AL-11', 'AL-12', 'AL-13A', 'AL-14'
];
...
export const GRADE_PAY_MAP: Record<string, number> = {
  ...
  'AL-10': 6000, 'AL-11': 7000, 'AL-12': 8000, 'AL-13A': 9000, 'AL-14': 10000
};
...
export const PAY_MATRIX: Record<string, number[]> = {
  ...
  'AL-10': [57700, 59400, 61200, 63000, 64900, 66800, 68800, 70900, 73000, 75200, 77500, 79800, 82200, 84700, 87200, 89800, 92500, 95300, 98200, 101100, 104100, 107200, 110400, 113700, 117100, 120600, 124200, 127900, 131700, 135700, 139800, 144000, 148300, 152700, 157300, 162000, 166900, 171900, 177100, 182400],
  'AL-11': [68900, 71000, 73100, 75300, 77600, 79900, 82300, 84800, 87300, 89900, 92600, 95400, 98300, 101200, 104200, 107300, 110500, 113800, 117200, 120700, 124300, 128000, 131800, 135800, 139900, 144100, 148400, 152900, 157500, 162200, 167100, 172100, 177300, 182600, 188100, 193700, 199500, 205500],
  'AL-12': [79800, 82200, 84700, 87200, 89800, 92500, 95300, 98200, 101100, 104100, 107200, 110400, 113700, 117100, 120600, 124200, 127900, 131700, 135700, 139800, 144000, 148300, 152700, 157300, 162000, 166900, 171900, 177100, 182400, 187900, 193500, 199300, 205300, 211500],
  'AL-13A': [131400, 135300, 139400, 143600, 147900, 152300, 156900, 161600, 166400, 171400, 176500, 181800, 187300, 192900, 198700, 204700, 210800, 217100],
  'AL-14': [144200, 148500, 153000, 157600, 162300, 167200, 172200, 177400, 182700, 188200, 193800, 199600, 205600, 211800, 218200]
};
...
export const DEPARTMENT_DATA: Department[] = [
    ...
    {
        "name": "COLLEGE EDUCATION DEPARTMENT",
        "posts": [
            {
                "title": "Assistant Professor (Entry Level / AL-10)",
                "level": "AL-10",
                "gradePay": 6000,
                "initialPay": 57700
            },
            {
                "title": "Assistant Professor (Senior Scale / AL-11)",
                "level": "AL-11",
                "gradePay": 7000,
                "initialPay": 68900
            },
            {
                "title": "Assistant Professor (Selection Grade / AL-12)",
                "level": "AL-12",
                "gradePay": 8000,
                "initialPay": 79800
            },
            {
                "title": "Associate Professor (AL-13A)",
                "level": "AL-13A",
                "gradePay": 9000,
                "initialPay": 131400
            },
            {
                "title": "Professor (AL-14)",
                "level": "AL-14",
                "gradePay": 10000,
                "initialPay": 144200
            },
            {
                "title": "Principal, PG College (AL-14)",
                "level": "AL-14",
                "gradePay": 10000,
                "initialPay": 144200
            },
            {
                "title": "Principal, UG College (AL-13A)",
                "level": "AL-13A",
                "gradePay": 9000,
                "initialPay": 131400
            },
            {
                "title": "Librarian (College / AL-10)",
                "level": "AL-10",
                "gradePay": 6000,
                "initialPay": 57700
            },
